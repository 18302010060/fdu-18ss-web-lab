...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              <?php
              $countries=array("Canada","Germany","Greece","Italy","United Kingdom","United States");
              for($i=0;$i<6;$i++){
              echo "<a href=\"list.php?country=Canada\" role=\"button\" class=\"btn btn-default\"> ".$countries[$i]."</a> ";
              }
