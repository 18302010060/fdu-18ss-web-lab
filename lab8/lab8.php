...
$shipping = 0;
$grandTotal = 0;
 function calAmount($quantity,$price){
    $amount=$quantity*$price;

    return $amount;
    }
$subtotal=calAmount($quantity1,$price1)+calAmount($quantity2,$price2)+calAmount($quantity3,$price3)+calAmount($quantity4,$price4);
if($subtotal>$shippingThreshold){
$shipping = 100;
}
else{
$shipping=$shippingFlatAmount = 200;
}
